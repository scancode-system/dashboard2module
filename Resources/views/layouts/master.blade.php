        ...
        <ul class="c-sidebar-nav">
            ...
            <li class="c-sidebar-nav-item c-sidebar-nav-dropdown"><a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href=""><span class="c-sidebar-nav-icon"></span> Listar</a></li>
                    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href=""><span class="c-sidebar-nav-icon"></span> Categorias</a></li>
                </ul>
            </li>
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link" href="">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="/modules/dashboard2/coreui/dist/vendors/@coreui/icons/svg/free.svg#cil-layers"></use>
                    </svg> Tecidos
                </a>
            </li>
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link" href="">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="/modules/dashboard2/coreui/dist/vendors/@coreui/icons/svg/free.svg#cil-vector"></use>
                    </svg> Moldes
                </a>
            </li>
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link" href="">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="/modules/dashboard2/coreui/dist/vendors/@coreui/icons/svg/free.svg#cil-color-palette"></use>
                    </svg> Cores
                </a>
            </li>
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link" href="">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="/modules/dashboard2/coreui/dist/vendors/@coreui/icons/svg/free.svg#cil-list"></use>
                    </svg> Coleções
                </a>
            </li>
        </ul>
            ...
            <ul class="c-header-nav ml-auto mr-4">
                ...
                <li class="c-header-nav-item dropdown">
                    <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                        <div class="c-avatar"><img class="c-avatar-img" src="/modules/dashboard2/coreui/dist/assets/img/avatars/6.jpg" alt="user@email.com"></div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right pt-0">
                        ...
                        <a class="dropdown-item" href="">
                            <svg class="c-icon mr-2">
                                <use xlink:href="/modules/dashboard2/coreui/dist/vendors/@coreui/icons/svg/free.svg#cil-user"></use>
                            </svg> Atualizar
                        </a>
